...
class MenuController extends Controller
{
     ...
     * @return string|null
     */
    private function generateCodeMenu(int $idModul = 0): ?string
    {
        if(empty($modul)) return null;

        return generateCodeBasic((new Menu)->getTable(),'code',$modul->code,['app_modul_id'=>$modul->id]);
    }
}
