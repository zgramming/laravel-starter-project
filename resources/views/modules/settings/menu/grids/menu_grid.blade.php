...
@section('content')
    <div class="d-flex flex-sm-column flex-md-row flex-lg-row justify-content-between my-3">
        ...
        <nav aria-label="breadcrumb" class="breadcrumb-header">
            <ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="{{ url('menu') }}">Setting</a></li>
                                ...
                                <div class="col-sm-12 col-md-6">
                                    <div class="d-flex flex-row">
                                        ...
                                        <div class="form-group mx-2">
                                            <select name="filter_modul" id="filter_modul" class="form-select select2-custom">
                                    ...
                                    <div class="d-flex flex-row justify-content-md-end justify-content-sm-start ">
                                        <div class="form-group">
                                            <div class="buttons">
                                                ...
                                                <a href="#" class="btn btn-success" onclick="openBox('{{url("setting/menu/form_modal/0")}}',
                                                    {size : 'modal-lg'}
...
@section('extends-js')
    <script type="text/javascript">
        $(document).ready(function(){
            const url = `{{url("setting/menu/datatable")}}`;
            ...
            $("#filter_modul").on('change',function(e){
                e.preventDefault();
                jqueryDatatable.draw();
            })
        });
