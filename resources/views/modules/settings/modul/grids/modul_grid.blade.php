...
@section('title_header') Modul @endsection
...
@section('content')
    <div class="d-flex flex-sm-column flex-md-row flex-lg-row justify-content-between my-3">
        <div>
            <h3>Modul</h3>
            <p class="text-subtitle text-muted">Menampilkan semua modul yang telah dibuat</p>
        </div>
        <nav aria-label="breadcrumb" class="breadcrumb-header">
            <ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="{{ url('setting/modul') }}">Setting</a></li>
                                ...
                                <div class="col-sm-12 col-md-6 mb-sm-3">
                                    <div class="d-flex flex-row justify-content-md-end justify-content-sm-start ">
                                        <div class="form-group">
                                            <div class="buttons">
                                                <a href="#" class="btn btn-info" onclick="openExport('{{ url('setting/modul/export') }}')"><span class="btn-label"><i class="fa fa-file-excel"></i></span> Export</a>
                                                <a href="#" class="btn btn-dark" onclick="openImport()"><span class="btn-label"><i class="fa fa-file-upload"></i></span> Import</a>
                                                <a href="#" class="btn btn-success" onclick="openBox('{{url('setting/modul/form_modal/0')}}')"><span class="btn-label"><i class="fa fa-plus"></i></span> Tambah</a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
...
@section('extends-js')
    <script type="text/javascript">
        $(document).ready(function(){
            const url = `{{url('setting/modul-datatable')}}`;
