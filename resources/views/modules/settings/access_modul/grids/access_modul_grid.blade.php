...
@section('title_header') Access Modul @endsection
...
@section('content')
    <div class="d-flex flex-sm-column flex-md-row flex-lg-row justify-content-between my-3">
        ...
        <nav aria-label="breadcrumb" class="breadcrumb-header">
            <ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="{{ url('setting/access-modul') }}">Setting</a></li>
                <li class="breadcrumb-item active" aria-current="page">Access Modul</li>
            </ol>
        </nav>
    </div>
    <div class="row">
                                ...
                                <div class="col-sm-12 col-md-6 mb-sm-3">
                                    <div class="d-flex flex-row justify-content-md-end justify-content-sm-start ">
                                        <div class="form-group">
                                            <div class="buttons">
                                                <a href="#" class="btn btn-info" onclick="openExport('{{ url('setting/access-modul/export') }}')"><span class="btn-label"><i class="fa fa-file-excel"></i></span> Export</a>
...
@section('extends-js')
    <script type="text/javascript">
        $(document).ready(function(){
            const url = `{{url('setting/access-modul/datatable')}}`;
