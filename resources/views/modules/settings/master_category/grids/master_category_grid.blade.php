                        ...
                        <div class="table-responsive">
                            <table class="table" style="width: 100%" id="table_datatable">
                                ...
                                <tr>
                                    ...
                                    <th style="min-width: 100px">Master Data</th>
        ...
        $(document).ready(function(){
            ...
            const jqueryDatatable = $("#table_datatable").DataTable({
                ...
                createdRow: function( row, data, dataIndex ) {
                    $( row ).find('td:eq(4)').attr('style','text-align:center; vertical-align:middle;');
                    $( row ).find('td:eq(5)').attr('style','text-align:center; vertical-align:middle;');
                },
